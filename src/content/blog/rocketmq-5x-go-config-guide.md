...
这篇主要按 RocketMQ 5.x gRPC Go SDK 的接入方式来讲。官方 Go SDK 示例和说明可以先放在旁边对照看，避免把项目封装层里的字段误认为 SDK 原生字段。([RocketMQ][1])
...
- [Apache RocketMQ Clients 仓库](https://github.com/apache/rocketmq-clients)
