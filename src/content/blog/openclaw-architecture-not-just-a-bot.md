...
这篇是 OpenClaw 系列的第一篇，重点放在整体架构和心智模型。后面两篇会继续拆：

1. [Gateway 架构：一个本地控制平面如何接管多渠道](/blog/openclaw-gateway-control-plane/)
2. [Agent Loop 原理拆解：一次消息如何变成模型调用和工具调用](/blog/openclaw-agent-loop-explained/)
...
[2]: https://docs.openclaw.ai/concepts/agent-loop
[3]: https://docs.openclaw.ai/
[4]: https://docs.openclaw.ai/concepts/agent-loop
